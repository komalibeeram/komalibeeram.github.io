...
function scrollHeader(){
    ...
    // when scroll > 80 viewport ht, add scroll header class
...
function scrollUp(){
    ...
    // when scroll is > 560 viewport ht add show-scroll class to a tag
...
if(selectedTheme){
    // if validation is fulfilled we ask what issue was to know if we activated or deactivated the dark theme
